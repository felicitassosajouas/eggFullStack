package Guia10Extra1dos.Servicio;
import Guia10Extra1dos.Entidades.Alquiler;
import Guia10Extra1dos.Entidades.Barco;
import Guia10Extra1dos.Entidades.BarcoaMotor;
import Guia10Extra1dos.Entidades.Velero;
import Guia10Extra1dos.Entidades.YatedeLujo;
...
public class Servicio {
    ...
    public void cargarDatos() {
        ...
        alquiler.setFechaAlquiler(LocalDate.parse(sc.nextLine(), formatoFecha));
        System.out.println("Ingrese la fecha de Salida DD/MM/AAAA");
        alquiler.setFechaDevolucion(LocalDate.parse(sc.nextLine(), formatoFecha));
