...
public class Metodos {
    ...
    public void crearPersona(){
        ...
        System.out.println("");
        System.out.println("Sexo --> M / H / O (Ingresar letra en mayúsculas!)");
        p.setSexo(leer.next());
        do {
            System.out.println("Sexo inválido, ingresarlo nuevamente");
            System.out.println("Sexo --> M / H / O (Ingresar letra en mayúsculas!)");
            p.setSexo(leer.next());
            }while (!"M".equals(p.getSexo()) || !"H".equals(p.getSexo()) || !"O".equals(p.getSexo()));
        ...
        System.out.println("Altura: " + p.getAltura()+ "mt2");
    }
