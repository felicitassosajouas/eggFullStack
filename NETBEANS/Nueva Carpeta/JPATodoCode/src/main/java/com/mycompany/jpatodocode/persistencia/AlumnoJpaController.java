...
public class AlumnoJpaController implements Serializable {
    ...
    //administra en entidades
    public AlumnoJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    
    //contructor que crea la entityManagerFactory a partir de la unidad de persistencia
    //mismo nombre que la clase donde se encuentra:
    public AlumnoJpaController(){
        emf = Persistence.createEntityManagerFactory("jpaTodoCode1");  
    }
